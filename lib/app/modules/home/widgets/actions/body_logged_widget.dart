        ...
        ListGroupActionsWidget(
          groups: [
            ...
            GroupActionsWidget(
              ...
              itemsActions: [
                ActionModel("Tele-Medicina", FontAwesomeIcons.laptopMedical,
                    () {
                  Modular.to.pushNamed("/emDesenvolvimento");
                }, true),
                ActionModel("Agendamentos", FontAwesomeIcons.calendarPlus, () {
                  Modular.to.pushNamed("/emDesenvolvimento");
                }, true),
                ...
                ActionModel(
                    "Atendimento Presencial", FontAwesomeIcons.clinicMedical,
                    () {
                  Modular.to.pushNamed("/emDesenvolvimento");
                }, true),
                ActionModel("Contato de Emergência", FontAwesomeIcons.ambulance,
                    () {
                  Modular.to.pushNamed("/emDesenvolvimento");
                }, true),
              ],
            ...
            GroupActionsWidget(
              ...
              itemsActions: [
                ...
                ActionModel("Mande um Recado", FontAwesomeIcons.paperPlane, () {
                  Modular.to.pushNamed("/emDesenvolvimento");
                }, true),
                ActionModel("Aprenda", FontAwesomeIcons.chalkboardTeacher, () {
                  Modular.to.pushNamed("/emDesenvolvimento");
                }, true),
              ],
            ),
